...
const CV = () => {
  const moment = {
    ...
    internship: 'Internship Front-End & Tester',
    ...
    center:'SoftTech',
    training:'Khóa đào tạo lập trình Front-end (HTML, CSS, React),  ',
    projects: 'Front-end: Website giới thiệu biển và dịch vụ (HTML,CSS), Front-end: Tạo CV bằng React (HTML,CSS)',
